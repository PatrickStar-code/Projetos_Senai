...
$sql = "SELECT * FROM clientes ORDER BY cod_cliente "; /*Fazendo o select*/
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow top-fixed" class="cabeca" style="background-color: #2d2926;">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation" style="position: relative;">
            ...
            <div class="col-lg-12">
                <div class="main-box clearfix">
                    <div class=" table-responsive">
                        <table class="table user-list" id="tabela_cliente">
                            <thead>
                                <tr>
                                    <th class="dundin"><span>Cliente</span></th>
                                    <th class="dundin"><span>Cpf</span></th>
                                    <th class="dundin"><span>Telefone</span></th>
                                    <th class="dundin"><span>Ações</span></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    if ($result == true) {
                                        while ($row = $result->fetch_assoc()) { ?>
                                            <td>
                                                ...
                                                <a href="#" class="user-link"><?php echo $row["nome_cliente"] ?></a>
                                                <span class="user-subhead">ID:<?php echo $row["cod_cliente"] ?></span>
                                            </td>
                                            ...
                                            <td style="width: 0%;">
                                                ...
                                                <!-- SEGUNDO BOTAO -->
                                                <a href="editar.php?cod_cliente=<?php echo $row['cod_cliente'] ?>" class="table-link">
                                                    <span class="fa-stack">
                                                ...
                                                <!-- TERCEIRO BOTAO -->
                                                <a href="#modal<?php echo $row["cod_cliente"] ?>del" class="table-link danger" data-toggle="modal">
                                                    <span class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
                                                ...
                                                <!-- MODAL -->
                                                <div id="modal<?php echo $row["cod_cliente"] ?>del" class="modal fade">
                                                    <div class="modal-dialog modal-confirm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer justify-content-center">
                                                                ...
                                                                <button type="button" class="btn btn-danger" onclick="deletar_cliente(<?php echo $row['cod_cliente'] ?>)" data-dismiss="modal">Deletar</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
