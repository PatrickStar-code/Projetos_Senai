	...
	<div class="bg-white text-black py-20">
		<div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
			<div class="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
				<h1 class="text-3xl md:text-5xl p-2 text-black-300 tracking-loose">TechFest</h1>
				...
				<a href="#"
					class="bg-transparent hover:bg-gray-300 text-white-300 hover:text-black rounded shadow hover:shadow-lg py-2 px-4 border border-black-500 hover:border-transparent">
					Explore Now</a>
			</div>
...
<div class="container mx-auto w-7/12 border-solid border-2 p-5 border-gray " >
    <h1 class="font-medium">DADOS PARA CADASTRO</h1>
    <br>
<form method="POST" action="salvar.php">
  ...
  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="submit" onclick="<?php ?>">Enviar</button>
</form>
</div>
<br>
<br>
...
<script>
    $('#floating_preco').mask('000.000.000.000.000,00', {reverse: true});;
</script>